...
void testb64Conversion()
{
	...
	char validateOnePad[] = "SSBuZXZlciBxdWl0ZSByZWFsaXplZC4uLiBob3cgYmVhdXRpZnVsIHRoaXMgd29ybGQgaXMuLi4=\0";
	char validateTwoPad[] = "V2Vpc3MsIHlvdSBkdW1iYXNzISBTdGFydCBtYWtpbmcgc2Vuc2UsIHlvdSByb3R0ZW4gYm9vaywgb3IgeW91J2xsIGJlIHNvcnJ5IQ==\0";
	printf((strcmp(bin_to_b64(b64_to_bin(validateNoPad)), validateNoPad) || strcmp(bin_to_b64(b64_to_bin(validateOnePad)), validateOnePad) || strcmp(bin_to_b64(b64_to_bin(validateTwoPad)), validateTwoPad)) ? "BASE 64 ENCODE/DECODE FAILED\n" : "base 64 encode/decode successful\n");
}
...
void testHexConversion()
{
	...
	printf((strcmp(bin_to_hex(hex_to_bin(testData)), testData) ) ? "HEX ENCODE/DECODE FAILED\n" : "hex encode/decode successful\n");
}
...
void testExample2()
{
	...
	char validate[] = "746865206b696420646f6e277420706c6179";
